...
Router::connect('/updateProfile/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'updateProfile'));
Router::connect('/setting/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'setting'));
