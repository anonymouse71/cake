		...
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				<h1><?php echo __('User Group Permissions');?></h1>
					<?php echo $this->Form->input("controller",array('label'=>'Select Controller','class'=>'form-control','type'=>'select','div'=>array('class'=>'form-group'),'options'=>$allControllers,'selected'=>$c,"onchange"=>"window.location='".SITE_URL."permissions/?c='+(this).value"))?>
			</div>
			<div class="umhr"></div>
