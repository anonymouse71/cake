...
<?php   if (count($userGroups) >2) { ?>
	<?php echo $this->Form->input("user_group_id" ,array('type' => 'select', 'label' => __('Choose Group'),'div' => array('class'=>'form-group col-md-12'),'class'=>"form-control required" ))?>
<?php   }   ?>
...
<?php echo $this->Form->input("national_idnumber" ,array('label' => __('National ID'),'div' => array('class'=>'form-group col-md-3'),'class'=>"form-control required" ))?>					
