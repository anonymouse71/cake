		...
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="addgroup">
				...
				<div>
					...
					<div class="umstyle4" ><?php echo $this->Form->input("name" ,array('label' => false,'div' => array('class'=>'form-group'),'class'=>"form-control required",'id'=>'name' ))?></div>
					<div class="umstyle7">for ex. Business User</div>
					<div style="clear:both"></div>
				</div>
				<div>
					<div class="umstyle3"><?php echo __('Alias Group Name');?><font color='red'>*</font></div>
					<div class="umstyle4" ><?php echo $this->Form->input("alias_name" ,array('label' => false,'div' => array('class'=>'form-group required'),'class'=>"form-control" ))?></div>
				...
				<div>
					...
					<div class="umstyle4"><?php echo $this->Form->Submit(__('Update Group'), array('class'=>'btn btn-success','id'=>'Submit'));?></div>
					<div style="clear:both"></div>
				</div>
...
<script>
    $(document).ready(function(){
         $("#Submit").on('click', function(e){
            ...
            if( $('#UserGroupEditGroupForm').valid())
            {
                    var str = $('#name').val();
                    if(/^[a-zA-Z0-9-]*$/.test(str) == false) 
                    {
                     ...
                     else{$( "#UserGroupEditGroupForm" ).submit();}
