 ...
 *  			
 */			
		'window_url' => Router::fullbaseUrl().'/ConfigurationsController/elfinder',		// call elfinder window
		'connector_url' => Router::fullbaseUrl().'/ConfigurationsController/connector',	// connect to retrive files
		'locale' => 'en', 
