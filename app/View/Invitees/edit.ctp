...
<?php echo $this->Form->create('Invitee'); ?>
	<fieldset>
		<legend><?php echo __('Edit Invitee'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Invitee.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Invitee.id'))); ?></li>
