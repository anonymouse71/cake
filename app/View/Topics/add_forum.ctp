...
<?php echo $this->Form->create('Topic'); ?>
	...
	<?php
		...
		echo $this->Form->input('created_by',array('div' => array('class' => 'form-group col-md-12'),'type'=>'hidden','class'=>'form-control', 'value'=>$_user['User']['username']));
	?>
	<div class='form-group col-md-12'><?php	echo $this->Form->input('status',array('type'=>'checkbox','label'=>'Active'));?></div>
	</fieldset>
