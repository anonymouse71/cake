    ...
    <div class="col-md-3 sidebar">
        ...
        <?php echo $this->element('blogs_sidebar/last_comment'); ?><br/>
        <?php echo $this->element('blogs_sidebar/last_registered'); ?><br/>
        <?php echo $this->element('blogs_sidebar/archives'); ?><br/>
