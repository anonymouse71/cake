					<ul class="dropdown-menu dropdown-menu-right icons-right">
							<li> <?php
									echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> Dashboard ',
                            ...
                            <li> <?php
									echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> All Users ',
                            ...
                            <li> <?php
                             ...
                             <li> <?php
									echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> All Groups ',
                             ...
                             <li class="divider"></li>
                              <li> <?php
									echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> Permissions ',
