...
<!--				</a>-->
			...
			<li class="user dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown">
					...
					<span><?php echo $this->session->read('UserAuth.UserGroup.name').' '.$this->session->read('UserAuth.User.username').' ('.$this->session->read('UserAuth.User.email').')';?></span>
					<i class="caret"></i>
				</a>
				<ul class="dropdown-menu dropdown-menu-right icons-right">
                    <li><?php echo $this->Html->link('<i class="icon-user"></i> Profile',array('plugin'=>'usermgmt','controller'=>'users','action'=>'myprofile'),array('escape'=>false));?></li>
                    <li><?php echo $this->Html->link('<i class="icon-user"></i> Edit Profile',array('plugin'=>'usermgmt','controller'=>'users','action'=>'editUser',$this->UserAuth->getUserId()),array('escape'=>false));?></li>
                     <li><?php echo $this->Html->link('<i class="icon-unlocked"></i> Change Password',array('plugin'=>'usermgmt','controller'=>'users','action'=>'changePassword'),array('escape'=>false));?></li>
