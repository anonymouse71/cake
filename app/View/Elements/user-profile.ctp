				...
				<div class="user-menu dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						height="50" width="50" />
						<div class="user-info">
							<?php echo $_user['User']['first_name'].' '.$_user['User']['last_name'] ?> <span><?php echo $_user['User']['username']?></span>
						</div>
					</a>
					<div class="popup dropdown-menu dropdown-menu-right">
					    <div class="thumbnail">
					    	...
					    	<div class="caption text-center">
					    		<h6><?php echo $_user['User']['first_name'].' '.$_user['User']['last_name'] ?><small><?php echo $_user['User']['username'] ?></small></h6>
					    	</div>
				    	</div>
<!--
				    	<ul class="list-group">
