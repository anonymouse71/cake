            ...
            <div class="panel-body">
                ...
                <ul class="info-blocks">
                    <li class="bg-primary">
                        ...
                        <span class="bottom-info bg-danger"><span id="admd-1"></span> <?php echo __('drafts') ?></span>
                    </li>
                    <li class="bg-success">
                        <div class="top-info">
                    ...
                    <li class="bg-danger">
                        ...
                        <span class="bottom-info bg-primary"><span id="admd-2"></span> <?php echo __('new updates') ?></span>
                    </li>
                    <li class="bg-info">
                        <div class="top-info">
                            <a href="#"><?php echo __('My messages') ?></a>
                            <small><span id="admd-6"></span> <?php echo __('messages history') ?></small>
                        </div>
                        <a href="#"><i class="icon-bubbles3"></i></a>
                        <span class="bottom-info bg-primary"><span id="admd-3"></span> <?php echo __('new messages') ?></span>
                    </li>
                    <li class="bg-primary">
                        <div class="top-info">
                        ...
                        <span class="bottom-info bg-danger"><span id="admd-4"></span> <?php echo __('new orders') ?></span>
                    </li>
                    <li class="bg-success">
                        <div class="top-info">
                        ...
                        <span class="bottom-info bg-primary"><span id="admd-5"></span> <?php echo __('new invoices') ?></span>
                    </li>
                </ul>
                <!-- /default info blocks -->
            </div>
...
//            console.log(data);
            ...
            $('#admd-3').html(data.total_received_message);

            $('#admd-6').html(data.total_sent_message);
...
<script>
    ...
    $(document).ready(function(){
        $.ajax({
            ...
            $('#admd-1').html(data.total_draft_post);
