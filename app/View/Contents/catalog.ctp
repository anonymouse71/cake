<ul class="list-unstyled list-inline">
    <li class="subject"><?php echo $this->Html->link(__('Add New Content'),array('plugin'=>'','controller'=>'contents','action'=>'add',$lessonId));?></li>
</ul><br/>
            ...
            foreach ($contents as $content): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link('<i class="icon-plus"></i>', array('controller'=>'contents','action' => 'add', $lessonId,$content['Content']['id']), array('escape'=>false,'title'=>'Add Subunit')); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
