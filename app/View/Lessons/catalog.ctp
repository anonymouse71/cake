...
<!--                <th>--><?php //echo $this->Paginator->sort('course_only'); ?><!--</th>-->
            ...
            <?php foreach ($lessons as $lesson): ?>
                <tr>
                    <td><?php echo $this->Html->link($lesson['Lesson']['name'], array('plugin'=>'','controller' => 'lessons', 'action' => 'lesson_home', $lesson['Lesson']['id'])); ?>&nbsp;</td>
                    <td>
                        <?php echo h($lesson['Category']['name']); ?>
                    </td>
                    <td class="text-center" id="seAvailability">
                        <?php if ($lesson['Lesson']['course_only']){ ?>
                            <i style="color:green;cursor:pointer" class="glyphicon glyphicon-eye-open setAvailable" title="Set Lesson Only" data-id="<?php echo $lesson['Lesson']['id'] ?>" data-status="1"></i>
                        <?php }else{ ?>
                            <i style="color:red;cursor:pointer" class="glyphicon glyphicon-eye-close setAvailable" title="Set Course Only" data-id="<?php echo $lesson['Lesson']['id'] ?>" data-status="0"></i>
                        <?php } ?>
                    </td>
...
<!--                    <td>--><?php //echo h($lesson['Lesson']['course_only']); ?><!--&nbsp;</td>-->
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link('<i class="icon-eye"></i>', array('action' => 'lesson_home', $lesson['Lesson']['id']), array('escape'=>false)); ?>
                        <?php echo $this->Html->link('<i class="icon-info"></i>', array('action' => 'lesson_info', $lesson['Lesson']['id']), array('escape'=>false)); ?>
...
<script type="text/javascript">
    $('.setAvailable').click(function(){
        ...
        var lessonId2 = $(obj).attr('data-id');
        console.log(lessonId2);
        var lessonStatus2 = $(obj).attr('data-status');
        ...
        $.get('<?php echo $this->webroot ?>lessons/set_lesson_availability/'+lessonId2+'/'+lessonStatus2,function(respData){
