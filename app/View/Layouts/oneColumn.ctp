...
<head>
    ...
    <?php
        ...
        if(isset($_user) && !empty($_user) && $this->params['action'] !='dashboard'){
            echo $this->Html->css('/bou/css/page-head');
        }elseif(isset($_user) && !empty($_user) && $this->params['action'] =='dashboard'){
            echo $this->Html->css('/bou/css/londinium-theme');
        }
