...
<?php echo $this->Form->create('Comment'); ?>
	...
	<?php
		...
		echo $this->Form->input('model_foreign_key',array('div' => array('class' => 'form-group col-md-12'), 'type'=>'hidden','class'=>'form-control'));
		...
		echo $this->Form->input('modified_by',array('div' => array('class' => 'form-group col-md-12'), 'type'=>'hidden','class'=>'form-control','value'=>$_user['User']['username']));
	?>
	</fieldset>
