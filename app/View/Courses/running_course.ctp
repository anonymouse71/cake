...
<div class="row">
            ...
            <div class="col-md-7">
                <div class="btn-group pull-right" role="group" aria-label="Basic example">
                    <ul class="nav navbar-nav">
                        <li><a class="btn btn-success" href="<?php echo $this->webroot ?>courses/running_course"><?php echo __('Running'); ?></a></li>
                        <li><a href="<?php echo $this->webroot ?>courses/past_course"><?php echo __('Past'); ?></a></li>
    ...
    <div class="col-md-3 sidebar">
        <?php echo $this->element('course/announcement'); ?><br/>
