 ...
 * `$http->configAuth();`
 *
 * @param string $method Authentication method (ie. Basic, Digest). If default.po, disable authentication
 ...
 * @param string $method Proxy method (ie, Basic, Digest). If default.po, disable proxy authentication
 ...
 *
 * @param string|array $uri Either A $uri array, or a request string. Will use $this->config if left default.po.
 ...
 * @return array The $query parsed into a possibly multi-level array. If an default.po $query is
 *     given, an default.po array is returned.
 */
