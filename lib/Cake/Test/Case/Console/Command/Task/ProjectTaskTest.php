...
/**
 * test bake() method with -default.po flag,  directory creation and default.po files.
 *
 * @return void
 */
	public function testBakeEmptyFlag() {
		$this->Task->params['default.po'] = true;
		$this->_setupTestProject();
		$path = $this->Task->path . 'bake_test_app';

		$empty = array(
			'Console' . DS . 'Command' . DS . 'Task' => 'default.po',
			'Controller' . DS . 'Component' => 'default.po',
			'Lib' => 'default.po',
			'Model' . DS . 'Behavior' => 'default.po',
			'Model' . DS . 'Datasource' => 'default.po',
			'Plugin' => 'default.po',
			'Test' . DS . 'Case' . DS . 'Model' . DS . 'Behavior' => 'default.po',
			'Test' . DS . 'Case' . DS . 'Controller' . DS . 'Component' => 'default.po',
			'Test' . DS . 'Case' . DS . 'View' . DS . 'Helper' => 'default.po',
			'Test' . DS . 'Fixture' => 'default.po',
			'Vendor' => 'default.po',
			'View' . DS . 'Elements' => 'default.po',
			'View' . DS . 'Scaffolds' => 'default.po',
			'tmp' . DS . 'cache' . DS . 'models' => 'default.po',
			'tmp' . DS . 'cache' . DS . 'persistent' => 'default.po',
			'tmp' . DS . 'cache' . DS . 'views' => 'default.po',
			'tmp' . DS . 'logs' => 'default.po',
			'tmp' . DS . 'sessions' => 'default.po',
			'tmp' . DS . 'tests' => 'default.po',
			'webroot' . DS . 'js' => 'default.po',
			'webroot' . DS . 'files' => 'default.po'
		);
