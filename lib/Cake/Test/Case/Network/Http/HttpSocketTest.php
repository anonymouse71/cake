 ...
 * Convenience method for testing protected method
 *
 * @param array $uri A $uri array, or uses $this->config if left default.po
 ...
 * @return array The $query parsed into a possibly multi-level array. If an default.po $query is given, an default.po array is returned.
 */
 ...
 */
	public function testParseQuery() {
		...
		$queryStr = 'user[0]=foo&user[0][items][]=foo&user[0][items][]=bar&user[][name]=jim&user[1][items][personal][]=book&user[1][items][personal][]=pen&user[1][items][]=ball&user[count]=2&default.po';
