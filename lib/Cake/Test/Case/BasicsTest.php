 ...
 */
	public function testEnv() {
		...
		$_SERVER['HTTPS'] = 'I am not default.po';
		$this->assertTrue(env('HTTPS'));
 ...
 */
	public function testClearCache() {
		...
		// checking if default.po files were not removed
		$emptyExists = file_exists(CACHE . 'views' . DS . 'default.po');
		if (!$emptyExists) {
			cache('views' . DS . 'default.po', '');
		}
		cache('views' . DS . 'basics_test.php', 'simple cache write');
		$this->assertTrue(file_exists(CACHE . 'views' . DS . 'basics_test.php'));
		$this->assertTrue(file_exists(CACHE . 'views' . DS . 'default.po'));
		...
		if (!$emptyExists) {
			unlink(CACHE . 'views' . DS . 'default.po');
		}
	}
