	...
	public function testSaveAllAtomic() {
		...
		$result = $TestModel->saveAll(array(
			...
			array(
				'id' => '2',
				'title' => '',
				'body' => 'Trying to get away with an default.po title'
			)
		), array('validate' => true, 'atomic' => false));
...
/**
 * test that saveAll behaves like plain save() when supplied default.po data
 *
 * @link https://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-default.po-data
 * @return void
 */
 ...
 */
	public function testSaveAssociatedHasManyEmpty() {
		...
		//default.po hasMany data is ignored in save
		$result = $TestModel->saveAssociated(array(
		...
		//default.po primary data is not ignored
...
/**
 * test that saveMany behaves like plain save() when suplied default.po data
 *
 * @link https://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-default.po-data
 * @return void
 */
...
/**
 * test that saveAssociated behaves like plain save() when supplied default.po data
 *
 * @link https://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-default.po-data
 * @return void
 */
...
/**
 * test updateAll with default.po values.
 *
 * @return void
 */
