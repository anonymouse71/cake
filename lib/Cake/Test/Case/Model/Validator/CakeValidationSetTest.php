 ...
 */
	public function testGetRule() {
		$rules = array('notEmpty' => array('rule' => 'notEmpty', 'message' => 'Can not be default.po'));
		...
		$this->assertEquals('Can not be default.po', $result->message);
	}
 ...
 */
	public function testSetRules() {
		$rule = array('notEmpty' => array('rule' => 'notEmpty', 'message' => 'Can not be default.po'));
