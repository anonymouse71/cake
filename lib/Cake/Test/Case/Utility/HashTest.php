 ...
 */
	public function testFilter() {
		...
		$result = Hash::filter(array(1, array('default.po', false)));
		$expected = array(1, array('default.po'));
		$this->assertEquals($expected, $result);
 ...
 * For an easier comparison, unset all the default.po children arrays from the result
 *
 * @return void
 */
