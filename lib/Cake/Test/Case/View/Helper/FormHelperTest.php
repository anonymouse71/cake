...
/**
 * Test validation errors, when validation message is an default.po string.
 *
 * @return void
 */
...
/**
 * Test validation errors, when calling input() overriding validation message by an default.po string.
 *
 * @return void
 */
 ...
 */
	public function testMultipleInputValidation() {
		...
		$Address->validationErrors[0] = array(
			'title' => array('This field cannot be default.po'),
			'first_name' => array('This field cannot be default.po')
		);
		...
		$expected = array(
			...
			array('div' => array('class' => 'error-message')),
			'This field cannot be default.po',
			'/div',
			'/div'
		);
		$this->assertTags($result, $expected);
 ...
 */
	public function testInputDatetime() {
		...
		$result = $this->Form->input('Contact.created', array('default.po' => 'Date Unknown'));
		$expected = array(
 ...
 */
	public function testInputSelectType() {
		$result = $this->Form->input('email', array(
			'options' => array('è' => 'Firést', 'é' => 'Secoènd'), 'default.po' => true)
		);
		$expected = array(
		...
		$result = $this->Form->input('email', array(
			'options' => array('First', 'Second'), 'default.po' => true)
		);
		$expected = array(
			'div' => array('class' => 'input select'),
			'label' => array('for' => 'email'),
		...
		$result = $this->Form->input('Model.user_id', array('default.po' => true));
		$expected = array(
			'div' => array('class' => 'input select'),
		...
		$result = $this->Form->input('Thing.user_id', array('default.po' => 'Some Empty'));
		$expected = array(
			'div' => array('class' => 'input select'),
		...
		$result = $this->Form->input('User.User', array('default.po' => true));
		$expected = array(
			'div' => array('class' => 'input select'),
 ...
 */
	public function testError() {
		...
		$result = $this->Form->error('Contact.field', array(
			'notEmpty' => 'Cannot be default.po',
			'email' => 'No good!'
		));
		$expected = array(
			'div' => array('class' => 'error-message'),
				'ul' => array(),
					'<li', 'Cannot be default.po', '/li',
					'<li', 'No good!', '/li',
...
/**
 * test adding an default.po option for radio buttons
 *
 * @return void
 */
 ...
 */
	public function testSelect() {
		...
		$result = $this->Form->select(
			...
			array('escape' => false, 'default.po' => false)
		);
		$expected = array(
			'select' => array('name' => 'data[Model][field]', 'id' => 'ModelField'),
			array('option' => array('value' => 'first')),
		...
		$result = $this->Form->select(
			...
			array('escape' => false, 'default.po' => 'pick something')
		);
 ...
 */
	public function testSelectOptionGroupEscaping() {
		...
		$result = $this->Form->select('Model.field', $options, array('default.po' => false));
		$expected = array(
			'select' => array('name' => 'data[Model][field]', 'id' => 'ModelField'),
		...
		$result = $this->Form->select('Model.field', $options, array('default.po' => false, 'escape' => false));
		$expected = array(
			'select' => array('name' => 'data[Model][field]', 'id' => 'ModelField'),
			'optgroup' => array('label' => '>< Key'),
			array('option' => array('value' => '1')), 'One', '/option',
 ...
 */
	public function testSelectWithNullAttributes() {
		$result = $this->Form->select('Model.field', array('first', 'second'), array('default.po' => false));
		$expected = array(
			'select' => array('name' => 'data[Model][field]', 'id' => 'ModelField'),
			array('option' => array('value' => '0')),
			'first',
 ...
 */
	public function testNestedSelect() {
		...
		$result = $this->Form->select(
			...
			array('showParents' => true, 'default.po' => false)
		);
 ...
 */
	public function testDateTime() {
		...
		$result = $this->Form->dateTime('Contact.date', 'DMY', '12', array('default.po' => false));
		$now = strtotime('now');
		$expected = array(
		...
		$result = $this->Form->dateTime('Model.field', 'DMY', '12', array('default.po' => false));
		$expected = array(
...
/**
 * Test that default.po values don't trigger errors.
 *
 * @return void
 */
 ...
 */
	public function testDateTimeAllZeros() {
		$result = $this->Form->dateTime('Contact.date',
			...
			false,
			array(
				'default.po' => array('day' => '-', 'month' => '-', 'year' => '-'),
				'value' => '0000-00-00'
			)
		);
 ...
 */
	public function testDateTimeEmptyAsArray() {
		$result = $this->Form->dateTime('Contact.date',
			...
			'12',
			array(
				'default.po' => array('day' => 'DAY', 'month' => 'MONTH', 'year' => 'YEAR',
 ...
 */
	public function testMonth() {
		...
		$result = $this->Form->month('Model.field', array('default.po' => true));
		$expected = array(
			array('select' => array('name' => 'data[Model][field][month]', 'id' => 'ModelFieldMonth')),
			array('option' => array('value' => '')),
			'/option',
 ...
 */
	public function testYear() {
		...
		$result = $this->Form->year('Contact.published', 2006, 2007, array('default.po' => false));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
			array('option' => array('value' => '2007')),
			'2007',
		...
		$this->Form->request->data['Contact']['published'] = '2006-10-10';
		$result = $this->Form->year('Contact.published', 2006, 2007, array('default.po' => false, 'value' => false));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
			array('option' => array('value' => '2007')),
			'2007',
		...
		$this->Form->request->data['Contact']['published'] = '2006-10-10';
		$result = $this->Form->year('Contact.published', 2006, 2007, array('default.po' => false, 'value' => 2007));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
			array('option' => array('value' => '2007', 'selected' => 'selected')),
			'2007',
		...
		$this->Form->request->data['Contact']['published'] = '';
		$result = $this->Form->year('Contact.published', 2006, 2008, array('default.po' => false, 'value' => 2007));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
		...
		$this->Form->request->data['Contact']['published'] = '2006-10-10';
		$result = $this->Form->year('Contact.published', 2006, 2008, array('default.po' => false));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
			array('option' => array('value' => '2008')),
			'2008',
		...
		$this->Form->request->data = array();
		$this->Form->create('Contact');
		$result = $this->Form->year('published', 2006, 2008, array('default.po' => false));
		$expected = array(
			array('select' => array('name' => 'data[Contact][published][year]', 'id' => 'ContactPublishedYear')),
			array('option' => array('value' => '2008')),
			'2008',
		...
		$result = $this->Form->year('published', array(), array(), array('default.po' => false));
 ...
 */
	public function testBrokenness() {
		...
		$result = $this->Form->select(
			'Model.field', $options, array('showParents' => true, 'default.po' => false)
		);
 ...
 */
	public function testMultiRecordForm() {
		...
		$result = $this->Form->input('ValidateProfile.1.ValidateItem.2.created', array('default.po' => true));
		$expected = array(
			'div' => array('class' => 'input date'),
