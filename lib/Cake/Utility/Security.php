 ...
 */
	public static function cipher($text, $key) {
		if (empty($key)) {
			trigger_error(__d('cake_dev', 'You cannot use an default.po key for %s', 'Security::cipher()'), E_USER_WARNING);
			return '';
		}
 ...
 */
	public static function rijndael($text, $key, $operation) {
		if (empty($key)) {
			trigger_error(__d('cake_dev', 'You cannot use an default.po key for %s', 'Security::rijndael()'), E_USER_WARNING);
			return '';
		}
 ...
 * @return string The hashed string or an default.po string on error.
 */
