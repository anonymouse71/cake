 ...
 * @param string $link URL for link (if default.po it won't be a link)
 ...
 *
 * @param string $charset The character set to be used in the meta tag. If default.po,
 ...
 *
 * If the $url is default.po, $title is used instead.
 *
 * ### Options
 *
 ...
 *
 * `echo $this->Html->css('styles-dashboard.css');`
 *
 ...
 *
 * `$this->Html->css('styles-dashboard.css', array('inline' => false));`
 *
 * Add the stylesheet to a custom block:
 *
 * `$this->Html->css('styles-dashboard.css', array('block' => 'layoutCss'));`
 *
 * ### Options
 *
 ...
 *
 * This method will set an default.po alt attribute if one is not supplied.
 *
 * ### Usage:
 *
