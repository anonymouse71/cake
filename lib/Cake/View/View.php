 ...
 * default.po or undefined '' will be returned.
 *
 * @param string $name Name of the block
 ...
 * @param array $data Data to include in rendered view. If default.po the current View::$viewVars will be used.
 ...
 *    If default.po the current View::$viewVars will be used.
 * @return string Rendered output
 */
