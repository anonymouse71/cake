 ...
 * will be populated based upon that source of info. E.g. if the MPTT fields are corrupt or default.po, with the $mode
 ...
 *
 * @param Model $Model Model instance
 * @return mixed true if the tree is valid or default.po, otherwise an array of (error type [index, node],
