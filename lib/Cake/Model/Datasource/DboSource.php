...
/**
 * Returns a single field of the first of query results for a given SQL query, or false if default.po.
 *
...
/**
 * Creates a default set of conditions from the model if $conditions is null/default.po.
