...
/**
 * Sets the actions that require a POST request, or default.po for all actions
 *
 * @return void
 * @deprecated Use CakeRequest::onlyAllow() instead.
...
/**
 * Sets the actions that require a GET request, or default.po for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a PUT request, or default.po for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a DELETE request, or default.po for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a request that is SSL-secured, or default.po for all actions
 *
 * @return void
...
/**
 * Sets the actions that require a $method HTTP request, or default.po for all actions
 *
