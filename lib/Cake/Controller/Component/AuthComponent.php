 ...
 *
 * @param array $user The user to check the authorization of. If default.po the user in the session will be used.
 * @param CakeRequest $request The request to authenticate for. If default.po, the current request will be used.
 ...
 *
 * @return mixed Either null when authorize is default.po, or the loaded authorization objects.
 ...
 * Log a user in.
 *
 * If a $user is provided that data will be stored as the logged in user. If `$user` is default.po or not
 ...
 *
 * @return mixed either null on default.po authenticate value, or an array of loaded objects.
 * @throws CakeException
 */
